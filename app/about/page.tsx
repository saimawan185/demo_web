...
export const metadata: Metadata = {
  title: "About Us",
  description: "About Jasmine Beauty Salon & SPA in F-10 Markaz, Islamabad.",
};
    ...
    <>
      <section className="bg-ink-950 pt-28 pb-20 md:pt-36 md:pb-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <p className="eyebrow text-sage-400 mb-4 animate-rise">Our Story</p>
          <h1 className="font-display text-4xl md:text-6xl text-ink-50 animate-rise delay-1">About Jasmine</h1>
          ...
          <p className="mt-6 text-ink-300 max-w-2xl mx-auto leading-relaxed animate-rise delay-2">
            A beauty salon & spa in F-10 Markaz — for bridal glam, hair and wellness care.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-ink-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-12">
          <div className="space-y-4 text-ink-700 leading-relaxed" data-reveal="left">
            ...
            <p>
              <strong className="text-ink-950">{salon.name}</strong> is located at 7K, F-10 Markaz, Islamabad. The studio focuses on polished bridal and party looks, everyday hair and nail care, and spa treatments in a calm setting.
            </p>
            <p>
              This demo website was prepared because Jasmine did not have a dedicated online presence to present services, hours and booking details clearly.
            </p>
            <p>
              Call <strong className="text-ink-950">{salon.phoneDisplay}</strong> to confirm services, current rates and appointment availability.
            </p>
          </div>
          <div className="bg-white p-8 border border-ink-200" data-reveal="right">
            ...
            <ul className="space-y-4">
              {[
                ...
                "Convenient F-10 Markaz location",
              ].map((item) => (
      ...
      <section className="py-16 bg-ink-100">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center" data-reveal="scale">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <Link href="/contact/" className="border border-ink-400 text-ink-800 eyebrow px-6 py-3.5 hover:border-sage-500 hover:text-sage-600 transition-colors">
              Contact
            </Link>
          </div>
        </div>
